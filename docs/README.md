...
| [`specs/local-git-engine-design.md`](specs/local-git-engine-design.md) | **本地 Git 引擎**：§3 稳定接口（27 个 `pub fn`，含阶段 3 的 5 个只读接口）/ §4 `nff:` 错误归一 / 证书与代理 / 已知边界 | `core/src/git/mod.rs:3` |
